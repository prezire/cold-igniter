<div id="user" class="update row">
  ...
  <div class="row">
    ...
    <div class="small-12 medium-12 large-6 columns">Date Of Birth: <input type="text" name="date_of_birth" value="<?php echo set_value('date_of_birth', $user->date_of_birth); ?>" /></div>
